  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-gray-900 rounded-xl p-8 border border-gray-800">
        ...
        <button
          onClick={googleLogin}
          className="w-full flex items-center justify-center gap-2 bg-white text-gray-900 rounded-lg py-2.5 text-sm font-medium hover:bg-gray-100 transition mb-5"
        >
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 rounded-lg py-2.5 text-sm font-medium transition"
          >
            {loading ? "..." : mode === "login" ? t("login_btn") : t("signup_btn")}
          </button>
        </form>
        ...
        <p className="text-center text-xs text-gray-500 mt-4">
          ...
          >
            {mode === "login" ? t("signup_btn") : t("login_btn")}
          </button>
        </p>
        {mode === "signup" && (
          <p className="text-center text-xs text-gray-600 mt-2">{t("terms")}</p>
        )}
      </div>
    </div>
  );
