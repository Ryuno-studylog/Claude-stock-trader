...
- **Japanese stocks trade in units of 100 shares (単元株). Always recommend quantities as multiples of 100**
- Exclude any stock where 100 shares exceeds the available budget
